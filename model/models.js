...
const clientSchema = new mongoose.Schema({
    ...
    iwallet: { type: mongoose.Schema.Types.ObjectId, ref: 'InvestmentWallet' },
    usdWallet: { type: mongoose.Schema.Types.ObjectId, ref: 'Wallet' },
...
const walletSchema = new mongoose.Schema({
    type: { type: String, required: true, enum: ["USD", "Inversiones"] },
...
const movementSchema = new mongoose.Schema({
    ...
    movement_state: { type: String, default: "Pendiente", enum: ["pendiente", "aprobado", "rechazado", "remitido", "cancelado", "resuelto"] },
...
const walletTransactionSchema = new mongoose.Schema({
    ...
    origin_wallet: { type: mongoose.Schema.Types.ObjectId, ref: 'Wallet', required: true },
    dest_wallet: { type: mongoose.Schema.Types.ObjectId, ref: 'Wallet', required: true },
...
const supportTicketSchema = new mongoose.Schema({
    ...
    email_title: { type: String, required: true },
    description_msg: { type: String, required: true },
});
...
const investmentSchema = new mongoose.Schema({
    ...
    state: { type: String, required: true, enum: ["pendiente", "en curso", "rechazado", "finalizado"] },
